...
import com.viewnext.kidaprojects.agenciaviajes.mapper.PasajeroMapper;
...
public class PasajeroService implements PasajeroRepository {
	...
	/**
	 * Comprueba si existe un pasajero con el identificador (ID) proporcionado en la base de datos.
	 *
	 * @param id El ID del pasajero que se va a buscar.
	 * @return true si existe un pasajero con el ID proporcionado, false si no se encuentra ningún pasajero con ese ID.
	 */
	@Override
	 ...
	 * @return El PasajeroDTO del pasajero actualizado en caso de éxito.
	 * @throws EntityNotFoundException Si el pasajero no se encuentra.
	 */
